...
})({"jNGEO":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "7dff8f840c9ed799";
...
},{}],"cZXDC":[function(require,module,exports) {
...
class Produto {
    ...
    selecionar() {
        ...
        if (this.tipo === "prato") app.pratoSelecionado = this;
        else if (this.tipo === "sobremesa") app.sobremesaSelecionada = this;
        else app.bebidaSelecionada = this;
        app.verificarPedido();
    }
    getView() {
...
class Pedido {
    ...
    confirmar() {
        ...
        document.querySelector(".confirmar-pedido .prato .nome").innerHTML = app.pratoSelecionado.nome;
        document.querySelector(".confirmar-pedido .prato .preco").innerHTML = app.pratoSelecionado.preco.toFixed(2);
        document.querySelector(".confirmar-pedido .bebida .nome").innerHTML = app.bebidaSelecionada.nome;
        document.querySelector(".confirmar-pedido .bebida .preco").innerHTML = app.bebidaSelecionada.preco.toFixed(2);
        document.querySelector(".confirmar-pedido .sobremesa .nome").innerHTML = app.sobremesaSelecionada.nome;
        document.querySelector(".confirmar-pedido .sobremesa .preco").innerHTML = app.sobremesaSelecionada.preco.toFixed(2);
...
class App {
    ...
    verificarPedido() {
        if (this.pratoSelecionado !== null && this.bebidaSelecionada !== null && this.sobremesaSelecionada !== null) {
            this.btnPedir.classList.add("ativo");
            this.btnPedir.disabled = false;
            this.btnPedir.innerHTML = "Fazer pedido";
            this.pedido = new Pedido(this.pratoSelecionado, this.bebidaSelecionada, this.sobremesaSelecionada);
        }
    }
}
const app = new App((0, _dataJs.pratos), (0, _dataJs.bebidas), (0, _dataJs.sobremesas));

},{"./data.js":"hsat2"}],"hsat2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "pratos", ()=>pratos);
parcelHelpers.export(exports, "bebidas", ()=>bebidas);
parcelHelpers.export(exports, "sobremesas", ()=>sobremesas);
const pratos = [
    {
...
},{}]},["jNGEO","cZXDC"], "cZXDC", "parcelRequirea6cb")

//# sourceMappingURL=index.0c9ed799.js.map
